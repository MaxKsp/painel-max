...
import { clearAssistantHistory, getAssistantHistory } from "./api"
                              ...
                              <div className="flex max-w-[85%] items-start gap-2.5">
                                ...
                                >
                                  ...
                                  {message.role === "assistant" && message.response.status !== "undone" ? (
                                    <AssistantResultCard response={message.response} onView={viewModule} />
                                  ) : null}
                                  {message.role === "assistant"
                                    ...
                                    <div className="mt-3 grid grid-cols-2 gap-2 border-t border-outline-variant pt-3">
                                      ...
                                      <button
                                        ...
                                        onClick={() => {
                                          pendingHistoryKey.current = activeHistoryKey
                                          void assistant.resolveConfirmation(message.response.actionToken as string, "confirm", message.response.module)
                                        }}
